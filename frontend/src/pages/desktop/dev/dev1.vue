...
import { $t, menuToName } from 'src/utils'
...
const columns = reactive([
  ...
  { name: 'fat', label: computed(() => $t('Fat (g)')), field: 'fat', sortable: true },
...
<template>
  <q-page class="column items-center justify-start">
    ...
    <FilterTableComponent :title="menuToName(route.path)" :columns="columns" :rows="originalRows" />
  </q-page>
</template>
