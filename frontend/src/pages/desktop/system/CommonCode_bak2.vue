...
import { SELECT_PRODUCT_GROUP_EXISTS } from 'src/api/admin-api'
import { useQuasar } from 'quasar'

const $q = useQuasar()

const selectedItem = ref<ProductCategory | null>(<ProductCategory>{})
const selectedCode = ref<CommonCode | null>(<CommonCode>{})
    ...
    >
      ...
      <template v-slot:before>
        <div class="q-pa-lg">
          ...
          <div class="column">
            ...
            <div class="row">
              ...
              <q-input
                type="number"
                outlined
                autocomplete="CODE_ID"
                v-model="selectedCode.CODE_ID"
                class="col"
                placeholder="숫자화된 데이터코드 입력"
                lazy-rules
                :rules="[
                (val) => (val && val.length > 0) || '코드명을 입력하지 않았습니다.',
              ]"
              />
            </div>
          </div>
          <div class="column q-my-md">
            ...
            <div class="row">
              ...
              <q-input
                spellcheck="false"
                outlined
                autocomplete="CODE_NAME"
                v-model="selectedCode.CODE_NAME"
                class="full-width"
                placeholder="관리자가 해독 가능한 코드 입력 ex)DJC2021.01"
              />
            </div>
          </div>
          <div class="column q-my-md">
            <div class="fieldLabel">상위 코드명<span class="required">*</span></div>
            <div class="row">
              <!-- prettier-ignore -->
            </div>
          </div>
          <div class="column q-my-md">
            <div class="fieldLabel">정렬 순서<span class="required">*</span></div>
            <div class="row">
              <!-- prettier-ignore -->
              <q-input
                type='number'
          ...
          <div class="column q-my-md">
            <div class="fieldLabel">설명<span class="required">*</span></div>
            <div class="row">
              <!-- prettier-ignore -->
              <q-input
                spellcheck="false"
                ...
                v-model="selectedCode.CODE_NAME"
                class="full-width"
                placeholder="코드 부연설명 입력"
              />
            </div>
          </div>
          <div class="column q-my-md">
            <div class="fieldLabel">기타</div>
            <div class="row">
              <!-- prettier-ignore -->
              <q-input
                type="textarea"
                ...
                outlined
                autocomplete="ETC"
                v-model="selectedCode.ETC"
                class="full-width"
                placeholder="세부 부연설명을 입력하세요"
              />
            </div>
          </div>
